...
# 📖 [Meal_Gallery] <a name="about-project"></a>
...
**[Meal_Gallery]** The main purpose of a meal gallery website is to provide a comprehensive and diverse collection of food images that highlight the artistry, creativity, and deliciousness of various dishes.
...
<br>
<code>
  git clone https://github.com/HtetWaiYan7191/meal-gallery.git
  cd meal-gallery.git
</code>
...
Feel free to check the [issues page](https://github.com/HtetWaiYan7191/meal-gallery/issues).
